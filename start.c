...
void printColoredChar(char c,char joueurSymbol1, char joueurSymbol2) {
    if (c == joueurSymbol1) 
        printf("\033[31m%c\033[0m", c); // Rouge
    else if (c == joueurSymbol2) 
        printf("\033[32m%c\033[0m", c); // Vert
    else 
        printf("%c", c); // Normal
}
...
void displayBoard() {
    ...
    for(int i = 0; i < SIZE; i+=3) {
        ...
        if ((ligne == 1) || (ligne == 7)) {
            printColoredChar(board[i],sj1,sj2); printf("--------");
            printColoredChar(board[i+1],sj1,sj2); printf("--------");
            printColoredChar(board[i+2],sj1,sj2); printf("\n");
            if (ligne == 1) printf("|        |        |\n");
        }
        if ((ligne == 2) || (ligne == 6)) {
            printf("|  "); printColoredChar(board[i],sj1,sj2); printf("-----");
            printColoredChar(board[i+1],sj1,sj2); printf("-----");
            printColoredChar(board[i+2],sj1,sj2); printf("  |\n");
            if (ligne == 2) 
                printf("|  |     |     |  |\n");
        ...
        if (ligne == 4) {
            ...
            printColoredChar(board[i+1],sj1,sj2); printf("--");
            printColoredChar(board[i+2],sj1,sj2); printf("     ");
            printColoredChar(board[i+3],sj1,sj2); printf("--");
            printColoredChar(board[i+4],sj1,sj2); printf("--");
            printColoredChar(board[i+5],sj1,sj2); printf("\n");
            printf("|  |  |     |  |  |\n");
        }
        ligne++;
    }
