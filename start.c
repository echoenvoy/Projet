...
char rules(){
    printf("Regles du Jeu : (Voir la documentation en annexe) \n"
           ...
           "   - Lorsqu’il n’y a plus de pion à poser, les joueurs deplacent leurs pions vers\n"
           ...
           "     qui n´appartiennent à aucun moulin. Au cas où tous les pions de l´adversaire forment des moulins,\n" 
