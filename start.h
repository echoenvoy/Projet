...
int rules(){
    printf("Règles du Jeu : (Voir la documentation en annexe) \n"
           "1. Le jeu se déroule en deux temps : la pose puis le mouvement.\n"
           ...
           "     à condition que celui-ci ne fasse pas partie d'un alignement protégé.\n"
           "3. Une fois sorti du jeu, un pion ne peut plus y rentrer.\n"
           "4. Le jeu s’achève quand un joueur n’a plus que deux pions ou ne peut plus jouer,\n"
